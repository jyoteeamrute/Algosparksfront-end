...
const ActiveClient = () => {
    ...
    const getUserData = async () => {
        try {
            setLoading(true);
            const data = await getActiveClient(currentPage, itemsPerPage);
    ...
    const handleSearch = async () => {
        try {
            setLoading(true);
            const data = await SearchActiveUsers(searchQuery);
                    ...
                    <CardHeader>
                        <div className="d-flex justify-content-between align-items-center custom-responsive-style">
                            <div>
                                ...
                                {/* <span>Below is the list of Active Clients along with their details.</span> */}
                            </div>
